...
A new-message notification contains an excerpt of up to 200 characters and is delivered through
Telegram's infrastructure. That excerpt leaves the Operator's infrastructure and is subject to
Telegram's own data handling. The full message text, attachments and chat content are not included.
